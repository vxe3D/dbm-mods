module.exports = {
  ...
  subtitle(data) {
    return `Set voice channel status: ${data.statusText}`;
  },
  ...
  html(isEvent, data) {
    ...
    <div class="vcstatus-box-fixed vcstatus-box-right" style="top: 22px; right: 15px;">
      <span class="vcstatus-version">v1.0.0</span>
    </div>
    ...
    <style>
      ...
      .vcstatus-warning {
        background: linear-gradient(90deg, #ffbaba 0%, #ffd6d6 100%);
